...
class RedpandaEventDispatcher:
    ...
    def _emit(
        ...
        logger.info("transport_redpanda.dispatch.%s", phase, extra={"redpanda_dispatch": lifecycle.__dict__})
        with self._observer_lock:
        ...
        for observer in observers:
            try:
                ...
                logger.exception("transport_redpanda.dispatch_observer_failed")
