...
def migrate_storage_postgres(
    ...
    *,
    ...
    return PostgresMigrationRunner(database_url, component=f"storage_postgres_{table_prefix}").upgrade((
...
__all__ = ["MigrationUnavailable", "PostgresMigrationRunner", "SchemaMigration", "migrate_storage_postgres"]
