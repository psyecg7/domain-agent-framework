"""Application-layer capability invocation over the core event vocabulary."""
...
class CapabilityInvoker:
    ...
    This is application composition, not core semantics: transport
    subscriptions own target-agent delivery, and this class never imports or
    calls an Agent or reacts recursively to results.
    """
