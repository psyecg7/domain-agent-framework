"""Conversational application composition built on core intent primitives."""
...
from agent_core import Capability, Event, CapabilityRegistry, IntentInterpreter

from .capability_invoker import EventTransport
...
class ConversationalGateway:
    ...
    def handle_result(
        ...
        *,
        ...
        # Result transports are at-least-once. A duplicate must be a harmless
        # no-op, never a KeyError that takes down the conversational edge.
